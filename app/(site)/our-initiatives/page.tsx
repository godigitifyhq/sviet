    ...
    <main className="bg-white text-black">
      ...
      <section className="bg-[#F8FAFF]">
        <div className="mx-auto max-w-7xl px-4 py-14 md:px-6 md:py-16">
          <h2 className="text-3xl font-bold tracking-tight text-[#111827] md:text-4xl">
            The Uniques - From College to Corporate
          </h2>
          ...
          <div className="mt-8 grid items-start gap-8 lg:grid-cols-[1fr_1.15fr]">
            ...
            <div>
              <div className="grid gap-3 sm:grid-cols-2">
                {UNIQUES_POINTS.map((item) => {
                  ...
                  return (
                    <article
                      key={item.title}
                      className="rounded-xl border border-[#DCE7FF] bg-white p-4 shadow-[0_6px_20px_rgba(30,42,120,0.06)]"
                    >
              ...
              <h3 className="mt-7 text-xl font-bold text-[#111827]">
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                {UNIQUES_CARDS.map((item) => (
                  <article
                    key={item}
                    className="rounded-lg border border-[#DCE7FF] bg-[linear-gradient(180deg,#FFFFFF_0%,#F8FAFF_100%)] px-4 py-3 text-sm font-medium text-[#1F2937]"
                  >
                    {item}
                  </article>
                ))}
      ...
      <section className="bg-[#F8FAFF]">
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-16 md:grid-cols-2 md:px-6 md:py-20">
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-[#111827] md:text-4xl">
              Super 60 - Elite Performance Batch
            </h2>
            ...
            <div className="mt-6 space-y-3">
              {SUPER60_POINTS.map((point) => (
                <article
                  key={point}
                  className="flex items-start gap-3 rounded-lg border border-[#DCE7FF] bg-white px-4 py-3"
                >
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-4 py-16 md:px-6 md:py-20">
          <h2 className="text-3xl font-bold tracking-tight text-[#111827] md:text-4xl">
            Communities &amp; Professional Chapters
          </h2>
          <p className="mt-4 max-w-3xl text-sm leading-relaxed text-[#6B7280] md:text-base">
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-4 py-16 md:px-6 md:py-20">
          <h2 className="text-3xl font-bold tracking-tight text-[#111827] md:text-4xl">
            Skills, Creativity &amp; Career Development
          </h2>
          <p className="mt-4 max-w-3xl text-sm leading-relaxed text-[#6B7280] md:text-base">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {SKILL_CARDS.map((item) => {
              ...
              return (
                <article
                  key={item.title}
                  className="rounded-xl border border-[#DCE7FF] bg-[linear-gradient(180deg,#FFFFFF_0%,#F8FAFF_100%)] p-5 text-center shadow-[0_8px_24px_rgba(30,42,120,0.08)]"
                >
      ...
      <section className="relative overflow-hidden bg-[#0f172a] py-16 md:py-20">
        ...
        <div className="relative mx-auto max-w-7xl px-4 text-white md:px-6">
          ...
          <p className="mt-5 max-w-3xl text-sm leading-relaxed text-white/90 md:text-base">
            ...
            student-led initiatives, preparing individuals to take on real-world
