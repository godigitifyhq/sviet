        ...
        <div className="grid gap-8 lg:grid-cols-[0.4fr_0.6fr] lg:gap-10">
          <div className="lg:sticky lg:top-25 lg:self-start">
            <h2 className="text-3xl font-semibold leading-tight text-[#111827] md:text-5xl">
              What else can <span className="bg-linear-to-r from-[#2563EB] to-[#f7941d] bg-clip-text font-extrabold text-transparent">you do</span>
              <br />
              while studying at SVIET
            </h2>
          ...
          <div className="space-y-4">
            {OPPORTUNITIES.map((item) => (
              <article key={item.title} className={`relative overflow-hidden rounded-2xl bg-linear-to-r ${item.tone} p-5 text-white shadow-sm transition hover:scale-[1.01] md:p-6`}>
                <div className="grid items-end gap-3 md:grid-cols-[1fr_auto]">
                  <div>
                    <h3 className="text-xl font-semibold leading-tight md:text-3xl">{item.title}</h3>
