...
const TRAINING_PHASES = [
  {
    phase: "Phase 1",
    title: "Foundation",
    points: ["Aptitude and analytical reasoning", "Communication and workplace confidence", "Core technical fundamentals"],
  },
  {
    phase: "Phase 2",
    title: "Advanced",
    points: ["Domain-specific technical tracks", "Project-based learning and hack challenges", "Problem-solving and interview simulations"],
  },
  {
    phase: "Phase 3",
    title: "Industry-Ready",
    points: ["Resume, portfolio, and profile optimization", "Mock assessments with recruiter-style feedback", "Internship and placement readiness roadmap"],
  },
] as const;
    ...
    <section className="bg-white px-4 py-16 md:px-6 md:py-20">
      <div className="mx-auto max-w-7xl">
        <div className="max-w-3xl">
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#f7941d]">Training Curriculum</p>
          ...
          <p className="mt-4 text-base leading-relaxed text-[#6B7280]">
            The placement training framework is phase-driven to progressively build capability, confidence, and hiring
            readiness.
          </p>
        </div>
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          {TRAINING_PHASES.map((item) => (
            <article key={item.title} className="rounded-2xl border border-[#DCE7FF] bg-[linear-gradient(180deg,#FFFFFF_0%,#F8FAFF_100%)] p-6 shadow-[0_8px_24px_rgba(30,42,120,0.08)]">
              <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[#f7941d]">{item.phase}</p>
